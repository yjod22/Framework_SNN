...
for r in range(10):
    ...
    txtTitle = 'v8.0_intensive_snn_tests19_conv_SNN_' + str(test_index+1) + '.txt'
    ...
    txtTitle = 'v8.0_intensive_snn_tests19_conv_BNN_' + str(test_index+1) + '.txt'
    with open(txtTitle, 'w') as outfile:
        # I'm writing a header here just for the sake of readability
        # Any line starting with "#" will be ignored by numpy.loadtxt
    ...
    # Write the array to disk
    txtTitle = 'v8.0_intensive_snn_tests19_maxpool_SNN_' + str(test_index+1) + '.txt'
    with open(txtTitle, 'w') as outfile:
        # I'm writing a header here just for the sake of readability
        # Any line starting with "#" will be ignored by numpy.loadtxt
