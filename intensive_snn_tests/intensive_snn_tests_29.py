...
#model.save_weights('v8.0_test_result_IntensiveTests_22.h5')
model.load_weights('v8.0_test_result_IntensiveTests_22.h5')
...
weight_SNs, listIndex = ut.GetConvolutionLayerWeightsSNNonAdaptive(model, 1, length, 1)
...
for r in range(10):
    ...
    txtTitle = 'v8.0_intensive_snn_tests29_conv_SNN_' + str(test_index+1) + '.txt'
    ...
    txtTitle = 'v8.0_intensive_snn_tests29_conv_BNN_' + str(test_index+1) + '.txt'
    with open(txtTitle, 'w') as outfile:
        # I'm writing a header here just for the sake of readability
        # Any line starting with "#" will be ignored by numpy.loadtxt
    ...
    # Write the array to disk
    txtTitle = 'v8.0_intensive_snn_tests29_maxpool_SNN_' + str(test_index+1) + '.txt'
    with open(txtTitle, 'w') as outfile:
        # I'm writing a header here just for the sake of readability
        # Any line starting with "#" will be ignored by numpy.loadtxt
