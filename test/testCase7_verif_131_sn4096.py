...
###############################################################################
#
#  Filename:     testCase7_verif_131_sn4096.py
#
###############################################################################
#  Description:
#  
...
# History
################################################################################
# File:        testCaseX_sn4096, WeightScaling_testCaseX_sn4096.py
# Version:     19.2
...
for r in range(iter_validation):
    ...
    if(test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.2_testCase7_verif_131_conv1', test_index,
    ...
    if (test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.2_testCase7_verif_131_conv2', test_index,
