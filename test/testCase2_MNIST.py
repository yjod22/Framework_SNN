...
for r in range(iter_validation):
    ...
    if(test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.2_testCase2_MNIST_conv1', test_index,
    ...
    hoConvLayer = HOConvolution(5, 5, kBits=kBits, baseMode="Mux", activationFunc="STanh", use_bias="False", scale=0.4)
    hoModel.Activation(hoConvLayer, stride=1)
    del (hoConvLayer)
    print("conv layer 2 done")

    if (test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.2_testCase2_MNIST_conv2', test_index,
