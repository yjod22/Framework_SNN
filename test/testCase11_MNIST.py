...
import WeightScaling_testCase7_MNIST
import numpy as np
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_testCase7_MNIST.WeightScale()],
                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('../results/#Epoch25_weights_of_1st_model_testCase7_MNIST.h5')
global_variables.bnModel.Evaluate(x_test[:800], y_test[:800], verbose=0, indexModel=1)

# Optimize the neural network
global_variables.bnModel.OptimizeNetwork('testCase7_MNIST',
                                         '../results/#Epoch25_weights_of_1st_model_testCase7_MNIST.h5',
                                         '../results/#Epoch1_weights_of_1st_model_testCase7_MNIST.h5',
                                         WeightScaling_testCase7_MNIST,
                                         cntIter=3,
                                         tupleLayer=(1, ),
                                         x_train=x_train,
                                         y_train=y_train,
...
global_variables.bnModel.Load_weights('../results/#Epoch24_weights_of_2nd_model_testCase7_MNIST.h5')
...
for r in range(iter_validation):
    ...
    if(test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.2_testCase11_MNIST_conv1', test_index,
    ...
    if (test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.2_testCase11_MNIST_conv2', test_index,
