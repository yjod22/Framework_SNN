...
import WeightScaling_testCase5_MNIST
import numpy as np
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_testCase5_MNIST.WeightScale()],
                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('../results/#Epoch25_weights_of_1st_model_testCase5_MNIST.h5')
...
for r in range(iter_validation):
    ...
    if(test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.2_testCase9_MNIST_conv1', test_index,
    ...
    if (test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.2_testCase9_MNIST_conv2', test_index,
