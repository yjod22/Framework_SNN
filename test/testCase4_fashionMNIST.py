...
###############################################################################
#
#  Filename:     testCase4_fashionMNIST.py
#
###############################################################################
#  Description:
#  
...
import WeightScaling_testCase4_fashionMNIST
import numpy as np
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_testCase4_fashionMNIST.WeightScale()],
                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('../results/#Epoch20_weights_of_1st_model_testCase4_fashionMNIST.h5')
global_variables.bnModel.Evaluate(x_test[:800], y_test[:800], verbose=0, indexModel=1)

# Optimize the neural network
#global_variables.bnModel.OptimizeNetwork('testCase4_fashionMNIST',
#                                         '../results/#Epoch2_weights_of_1st_model_testCase4_fashionMNIST.h5',
#                                         '../results/#Epoch1_weights_of_1st_model_testCase4_fashionMNIST.h5',
#                                         WeightScaling_testCase4_fashionMNIST,
#                                         cntIter=3,
#                                         tupleLayer=(1, ),
#                                         x_train=x_train,
#                                         y_train=y_train,
