...
###############################################################################
#
#  Filename:	testCase3_verif_131_sn4096.py
...
"""
import WeightScaling_testCase7_verif_131
...
global_variables.bnModel[0] = Conv2D(8, kernel_size=(4, 4),
                                     ...
                                     use_bias=False,
                                     kernel_regularizer=regularizers.l1(0.0008))
...
#                             epochs=epochs,
#                             verbose=0,
#                             callbacks=[WeightScaling_testCase7_verif_131.WeightScale()],
#                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('../results/#Epoch20_weights_of_1st_model_testCase7_verif_131.h5')
...
#global_variables.bnModel.OptimizeNetwork('testCase7_verif_131',
#                                         '../results/#Epoch20_weights_of_1st_model_testCase7_verif_131.h5',
#                                         '../results/#Epoch1_weights_of_1st_model_testCase7_verif_131.h5',
#                                         WeightScaling_testCase7_verif_131,
#                                         cntIter=3,
#                                         tupleLayer=(1, ),
#                                         x_train=x_train,
#                                         y_train=y_train,
...
global_variables.bnModel.Load_weights('../results/#Epoch19_weights_of_2nd_model_testCase7_verif_131.h5')
...
for r in range(iter_validation):
    ...
    if(test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/testCase3_verif_131_conv1', test_index,
    ...
    hoConvLayer = HOConvolution(5, 5, kBits=kBits, modeAddConv="Mux", activationFunc="STanh", use_bias="False",
    ...
    if (test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/testCase3_verif_131_conv2', test_index,
