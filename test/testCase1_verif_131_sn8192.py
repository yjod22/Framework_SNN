...
###############################################################################
#
#  Filename:	testCase1_verif_131_sn8192.py
...
for r in range(iter_validation):
    ...
    if(test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/testCase1_verif_131_conv1', test_index,
    ...
    if (test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/testCase1_verif_131_conv2', test_index,
