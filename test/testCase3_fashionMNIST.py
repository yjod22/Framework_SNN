...
###############################################################################
#
#  Filename:     testCase3_fashionMNIST.py
#
###############################################################################
#  Description:
#  
...
import WeightScaling_testCase3_fashionMNIST
import numpy as np
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_testCase3_fashionMNIST.WeightScale()],
                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('../results/#Epoch20_weights_of_1st_model_testCase3_fashionMNIST.h5')
global_variables.bnModel.Evaluate(x_test[:800], y_test[:800], verbose=0, indexModel=1)

# Optimize the neural network
global_variables.bnModel.OptimizeNetwork('testCase3_fashionMNIST',
                                         '../results/#Epoch20_weights_of_1st_model_testCase3_fashionMNIST.h5',
                                         '../results/#Epoch1_weights_of_1st_model_testCase3_fashionMNIST.h5',
                                         WeightScaling_testCase3_fashionMNIST,
                                         cntIter=3,
                                         tupleLayer=(1, 4),
                                         x_train=x_train,
                                         y_train=y_train,
...
for r in range(iter_validation):
    ...
    hoDenseLayer = HOConnected(kBits=kBits, stochToInt="Mux", activationFunc="None", use_bias="True")
