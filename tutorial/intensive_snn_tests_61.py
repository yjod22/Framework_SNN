...
import WeightScaling_intensiveTests_61
...
for r in range(30):
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('v11.0_intensive_snn_tests61_conv1', test_index,
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('v11.0_intensive_snn_tests61_maxpool', test_index,
