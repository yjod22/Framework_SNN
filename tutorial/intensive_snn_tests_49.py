...
#model.save_weights('v8.0_test_result_IntensiveTests_49.h5')
model.load_weights('v8.0_test_result_IntensiveTests_49.h5')
...
txtTitle = 'v8.0_Intensive_snn_tests49.txt'
