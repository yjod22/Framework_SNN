...
#              epoch: 20, 1+19
#              # of test cases: 30
#              Conv(5, 4x4, Non-bias, L1=0.0007), activation function(tanh(x)), 
...
import WeightScaling_intensiveTests_54
...
global_variables.bnModel[0] = Conv2D(5, kernel_size=(4, 4),
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_intensiveTests_54.WeightScale()],
                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('results/#Epoch20 weights of 1st model_tests54.h5')
...
global_variables.bnModel.OptimizeNetwork('tests54',
                                         'results/#Epoch20 weights of 1st model_tests54.h5',
                                         'results/#Epoch1 weights of 1st model_tests54.h5',
                                         WeightScaling_intensiveTests_54,
                                         x_train=x_train,
                                         y_train=y_train,
                                         x_test=x_test,
                                         y_test=y_test,
...
for r in range(30):
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('v8.0_intensive_snn_tests54_conv', test_index,
                           hoModel.GetOutputMatrix(), 5, 25, 25,
                           layer2model, x_test)
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('v8.0_intensive_snn_tests54_maxpool', test_index,
                           hoModel.GetOutputMatrix(), 5, 12, 12,
                           layer3model, x_test)
