...
#              epoch: 20, 1+19
#              # of test cases: 30
#              Conv(2, 4x4, Non-bias, L1=0.0007), activation function(tanh(x)), 
#              Conv(5, 3x3, Non-bias, L1=0.0007), activation function(tanh(x)), 
...
import WeightScaling_intensiveTests_56
...
#                             epochs=epochs,
#                             verbose=0,
#                             callbacks=[WeightScaling_intensiveTests_56.WeightScale()],
#                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('results/#Epoch20 weights of 1st model_tests56.h5')
...
global_variables.bnModel.OptimizeNetwork('tests56',
                                         'results/#Epoch20 weights of 1st model_tests56.h5',
                                         'results/#Epoch1 weights of 1st model_tests56.h5',
                                         WeightScaling_intensiveTests_56,
                                         tupleLayer=(1, 3),
                                         x_train=x_train,
                                         y_train=y_train,
                                         x_test=x_test,
...
for r in range(30):
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('v8.0_intensive_snn_tests56_conv', test_index,
    ...
    #hoModel.SetBias(bias_SNs)
    hoConvLayer = HOConvolution(3, 3, length, baseMode="Mux", activationFunc="STanh")
    hoModel.Activation(hoConvLayer, stride=1)
    del(hoConvLayer)
    print("conv layer 2 done")

    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('v8.0_intensive_snn_tests56_conv2', test_index,
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('v8.0_intensive_snn_tests56_maxpool', test_index,
