...
# File:		   bnlayer.py
# Version:     8.0 (SCR_V??)
# Author/Date: Junseok Oh / 2019-05-08
# Change:      This software is branched from v8.0-PreV05-intensive_snn_tests_38.py
# Cause:       Automate the retraining process with the given models
...
import WeightScaling_intensiveTests_38
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_intensiveTests_38.WeightScale()],
                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('results/#Epoch20 weights of 1st model_tests38.h5')
...
global_variables.bnModel.OptimizeNetwork('tests38',
                                         'results/#Epoch20 weights of 1st model_tests38.h5',
                                         'results/#Epoch1 weights of 1st model_tests38.h5',
                                         WeightScaling_intensiveTests_38,
                                         x_train=x_train,
                                         y_train=y_train,
                                         x_test=x_test,
                                         y_test=y_test,
