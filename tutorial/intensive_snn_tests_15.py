...
#              Conv(1, 4x4), activation function(tanh(0.7x)), Conv(10, 4x4), activation function(tanh(0.7x)),
...
model.add(Conv2D(10, kernel_size=(4, 4), use_bias=False))  # with APC
...
#model.save_weights('v6.4_test_result_IntensiveTests_15.h5')
model.load_weights('v6.4_test_result_IntensiveTests_15.h5')
...
for r in range(10):
    ...
    txtTitle = 'v6.4_intensive_snn_tests15_conv_SNN1_' + str(test_index+1) + '.txt'
    ...
    txtTitle = 'v6.4_intensive_snn_tests15_conv_BNN1_' + str(test_index+1) + '.txt'
    with open(txtTitle, 'w') as outfile:
        # I'm writing a header here just for the sake of readability
        # Any line starting with "#" will be ignored by numpy.loadtxt
    ...
    # Convert Stochastic number to Binary number
    conv_out_test = np.zeros((10, 22, 22))
    for i in range(10):
        for j in range(22):
            for k in range(22):
                conv_out_test[i, j, k] = stochtoint(conv_output[i, j, k])
    ...
    # Write the array to disk
    txtTitle = 'v6.4_intensive_snn_tests15_conv_SNN2_' + str(test_index+1) + '.txt'
    with open(txtTitle, 'w') as outfile:
        # I'm writing a header here just for the sake of readability
        # Any line starting with "#" will be ignored by numpy.loadtxt
        outfile.write('# Array shape: {0}\n'.format(conv_out_test.shape))
    ...
    txtTitle = 'v6.4_intensive_snn_tests15_conv_BNN2_' + str(test_index+1) + '.txt'
    with open(txtTitle, 'w') as outfile:
        # I'm writing a header here just for the sake of readability
        # Any line starting with "#" will be ignored by numpy.loadtxt
        outfile.write('# Array shape: {0}\n'.format(BNN_prediction[0].shape))
    ...
    # Convert Stochastic number to Binary number
    max_pool_out_test = np.zeros((10, 11, 11))
    for i in range(10):
        for j in range(11):
            for k in range(11):
    ...
    # Write the array to disk
    txtTitle = 'v6.4_intensive_snn_tests15_maxpool_SNN_' + str(test_index+1) + '.txt'
    with open(txtTitle, 'w') as outfile:
        # I'm writing a header here just for the sake of readability
        # Any line starting with "#" will be ignored by numpy.loadtxt
    ...
    txtTitle = 'v6.4_intensive_snn_tests15_maxpool_BNN_' + str(test_index+1) + '.txt'
    with open(txtTitle, 'w') as outfile:
        # I'm writing a header here just for the sake of readability
        # Any line starting with "#" will be ignored by numpy.loadtxt
        outfile.write('# Array shape: {0}\n'.format(BNN_prediction[0].shape))
