...
#              epoch: 2
#              # of test cases: 100
#              Dense(100), activation function(relu), Dense(10), activation function(softmax)
...
#model.save_weights('v8.0_test_result_IntensiveTests_50.h5')
model.load_weights('v8.0_test_result_IntensiveTests_50.h5')
...
dense_weight_SNs = ut.GetConnectedLayerWeightsSN(model, 2, length)
...
for r in range(100):
    ...
    hoDenseLayer = HOConnected(length, stochToInt="APC", activationFunc="Relu")
...
txtTitle = 'v8.0_Intensive_snn_tests50.txt'
