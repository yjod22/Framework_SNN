...
txtTitle = 'v8.0_intensive_snn_tests44_weights1' + '.txt'
...
for r in range(100):
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('v8.0_intensive_snn_tests44_conv', test_index,
    ...
    sentences += '\n' + 'maxpool layer done'
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('v8.0_intensive_snn_tests44_maxpool', test_index,
...
txtTitle = 'v8.0_Intensive_snn_tests44.txt'
with open(txtTitle, 'w') as outfile:
    # I'm writing a header here just for the sake of readability
    # Any line starting with "#" will be ignored by numpy.loadtxt
    #outfile.write('# Array shape: {0}\n'.format(weights.shape))
