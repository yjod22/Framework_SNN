...
from intensive_snn_tests import WeightScaling_intensiveTests_57
...
for r in range(30):
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v12.0_intensive_snn_tests57_conv', test_index,
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v12.0_intensive_snn_tests57_conv2', test_index,
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v12.0_intensive_snn_tests57_maxpool', test_index,
