...
from intensive_snn_tests import WeightScaling_intensiveTests_60
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_intensiveTests_60.WeightScale()],
                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('../results/#Epoch5 weights of 1st model_tests60.h5')
...
for r in range(30):
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v12.0_intensive_snn_tests60_conv1', test_index,
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v12.0_intensive_snn_tests60_maxpool', test_index,
