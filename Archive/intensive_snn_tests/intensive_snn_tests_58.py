...
#              Conv(2, 4x4), activation function(Clipped-ReLU), maxPooling(2x2), Dense(10), activation function(softmax)
...
import WeightScaling_intensiveTests_58
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_intensiveTests_58.WeightScale()],
                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('results/#Epoch5 weights of 1st model_tests58.h5')
...
for r in range(30):
    ...
    hoConvLayer = HOConvolution(4, 4, length, baseMode="APC", activationFunc="SCRelu", use_bias="False")
    hoModel.Activation(hoConvLayer, stride=1)
    del(hoConvLayer)
    print('conv layer 1 done')

    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('v10.0_intensive_snn_tests58_conv1', test_index,
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('v10.0_intensive_snn_tests58_maxpool', test_index,
