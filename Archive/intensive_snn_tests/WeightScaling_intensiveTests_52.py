...
class WeightScale(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if(global_variables.bnModel.GetId() == 1):
            global_variables.bnModel.Save_weights('results/#Epoch' + str(global_variables.cntEpochs)+' weights of 1st model_tests52.h5')
        elif(global_variables.bnModel.GetId() == 2):
            global_variables.bnModel.Save_weights('results/#Epoch' + str(global_variables.cntEpochs)+' weights of 2nd model_tests52.h5')
