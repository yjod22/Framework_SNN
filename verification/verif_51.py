...
from verification import WeightScaling_verif_51
import numpy as np
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_verif_51.WeightScale()],
                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('../results/#Epoch20_weights_of_1st_model_verif_51.h5')
...
global_variables.bnModel.OptimizeNetwork('verif_51',
                                         '../results/#Epoch20_weights_of_1st_model_verif_51.h5',
                                         '../results/#Epoch1_weights_of_1st_model_verif_51.h5',
                                         WeightScaling_verif_51,
                                         cntIter=1,
                                         tupleLayer=(1, ),
                                         x_train=x_train,
                                         y_train=y_train,
...
for r in range(10):
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v15.0_verif_51_conv1', test_index,
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v15.0_verif_51_maxpool', test_index,
