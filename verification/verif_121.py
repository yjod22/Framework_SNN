...
from verification import WeightScaling_verif_121
import numpy as np
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_verif_121.WeightScale()],
                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('../results/#Epoch20_weights_of_1st_model_verif_121.h5')
...
for r in range(iter_validation):
    ...
    hoConvLayer = HOConvolution(5, 5, kBits=kBits, baseMode="APC", activationFunc="BTanh", use_bias="True",
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v16.0_verif_121_conv1', test_index,
    ...
    if (test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v16.0_verif_121_maxpool1', test_index,
                           hoModel.GetOutputMatrix(), 4, 12, 12,
                           layer3model, x_test)
        print(str(test_index + 1) + ' maxpool 1 layer results saved in txt format')

    # convolutional layer 2
    hoModel.SetNumOutputPlanes(12)  # The number of slices:12
    ...
    if (test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v16.0_verif_121_conv2', test_index,
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v16.0_verif_121_maxpool2', test_index,
