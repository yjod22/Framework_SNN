...
from verification import WeightScaling_verif_111
import numpy as np
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_verif_111.WeightScale()],
                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('../results/#Epoch20_weights_of_1st_model_verif_111.h5')
...
global_variables.bnModel.OptimizeNetwork('verif_111',
                                         '../results/#Epoch20_weights_of_1st_model_verif_111.h5',
                                         '../results/#Epoch1_weights_of_1st_model_verif_111.h5',
                                         WeightScaling_verif_111,
                                         cntIter=5,
                                         tupleLayer=(1, ),
                                         x_train=x_train,
                                         y_train=y_train,
...
dense_5_weight_SNs, dense_5_biases_SNs, listIndexDense = ut.GetConnectedLayerWeightsBiasesSN(model, 5, Adaptive="True")
...
for r in range(iter_validation):
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v19.0_verif_111_conv1', test_index,
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v19.0_verif_111_maxpool', test_index,
    ...
    hoModel.SetDenseBias(dense_5_biases_SNs)
