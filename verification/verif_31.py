...
from verification import WeightScaling_verif_31
import numpy as np
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_verif_31.WeightScale()],
                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('../results/#Epoch10_weights_of_1st_model_verif_31.h5')
...
for r in range(iter_validation):
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v15.0_verif_31_conv1', test_index,
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v15.0_verif_31_maxpool', test_index,
