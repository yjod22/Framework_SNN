...
###############################################################################
#
#  Filename:     verif_131_fashionMNIST.py
#
###############################################################################
#  Description:
#  
...
from verification import WeightScaling_verif_131_fashionMNIST
import numpy as np
...
#                             epochs=epochs,
#                             verbose=0,
#                             callbacks=[WeightScaling_verif_131_fashionMNIST.WeightScale()],
#                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('../results/#Epoch20_weights_of_1st_model_verif_131_fashionMNIST.h5')
...
#                                         '../results/#Epoch20_weights_of_1st_model_verif_131_fashionMNIST.h5',
#                                         '../results/#Epoch1_weights_of_1st_model_verif_131_fashionMNIST.h5',
...
for r in range(iter_validation):
    ...
    if(test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.1_verif_131_fashionMNIST_conv1', test_index,
    ...
    if (test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.1_verif_131_fashionMNIST_maxpool', test_index,
    ...
    if (test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.1_verif_131_fashionMNIST_conv2', test_index,
    ...
    if(test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.1_verif_131_fashionMNIST_maxpool2', test_index,
