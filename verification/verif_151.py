...
from verification import WeightScaling_verif_151
import numpy as np
...
global_variables.bnModel[0] = Conv2D(8, kernel_size=(3, 3),
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_verif_151.WeightScale()],
                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('../results/#Epoch20_weights_of_1st_model_verif_151.h5')
...
weight_2_SNs, bias_2_SNs, listIndex2 = ut.GetConvolutionLayerWeightsBiasesSN(model, 4, Adaptive="False")

dense_weight_SNs, dense_biases_SNs, listIndexDense = ut.GetConnectedLayerWeightsBiasesSN(model, 8, Adaptive="False")
...
for r in range(iter_validation):
    ...
    hoConvLayer = HOConvolution(3, 3, kBits=kBits, baseMode="Mux", activationFunc="ReluByMax", use_bias="True")
    ...
    if(test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.0_verif_151_conv1', test_index,
                           hoModel.GetOutputMatrix(), 8, 26, 26,
                           layer2model, x_test)
    ...
    if (test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.0_verif_151_maxpool', test_index,
                           hoModel.GetOutputMatrix(), 8, 13, 13,
                           layer3model, x_test)
    ...
    if (test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.0_verif_151_conv2', test_index,
                           hoModel.GetOutputMatrix(), 8, 9, 9,
                           layer5model, x_test)
    ...
    if(test_index % 100 == 0):
        ut.SaveInTxtFormat('../results/v19.0_verif_151_maxpool2', test_index,
