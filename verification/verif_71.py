...
from verification import WeightScaling_verif_71
import numpy as np
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_verif_71.WeightScale()],
...
for r in range(10):
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v15.0_verif_71_conv1', test_index,
    ...
    if(test_index % 10 == 0):
        ut.SaveInTxtFormat('../results/v15.0_verif_71_maxpool', test_index,
