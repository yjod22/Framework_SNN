...
# Change:      (SCR_V18.0-1): Update more test cases
# Cause:       -
...
from verification import WeightScaling_verif_141
import numpy as np
...
global_variables.bnModel.Fit(x_train, y_train,
                             ...
                             epochs=epochs,
                             verbose=0,
                             callbacks=[WeightScaling_verif_141.WeightScale()],
                             validation_data=(x_test, y_test))
global_variables.bnModel.Load_weights('../results/#Epoch20_weights_of_1st_model_verif_141.h5')
...
for r in range(iter_validation):
    ...
    hoConvLayer = HOConvolution(5, 5, kBits=kBits, baseMode="APC", activationFunc="SCRelu", use_bias="True")
